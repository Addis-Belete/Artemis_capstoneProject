...
void bid_2_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void bid_2_run(uint ctx_index,Circom_CalcWit* ctx);
